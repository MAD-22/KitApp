...
public class BookFragment extends Fragment {
    ...
    private ArrayList<Book> daftarCardModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mDatabaseReference.child("book").addValueEventListener(new ValueEventListener(){
            @Override
            public void onDataChange(DataSnapshot dataSnapshot){
                ...
                for (DataSnapshot mDataSnapshot : dataSnapshot.getChildren()){
                    Book book = mDataSnapshot.getValue(Book.class);
                    book.setKey(mDataSnapshot.getKey());
                    daftarCardModel.add(book);
                }
